...
const BlockMapCpWrapper = styled.div`
  position: relative;
  .blockName {
    font-size: 14px;
...
`;
const BlockMapCpWrap = styled.div`
  /* height: 1000px; */
  height: 409px;
...
const BlockMapCp = ({ mapBlock, dongList, subwayList, guList, seoulLine }) => {
  ...
  return (
    <BlockMapCpWrapper>
      <BlockMapCpWrap id="map" onMouseUp={onMouseUp}></BlockMapCpWrap>
...
export default React.memo(BlockMapCp);
