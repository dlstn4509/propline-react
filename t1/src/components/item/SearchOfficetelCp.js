  ...
  return (
    <SearchCpWrapper>
      <FilterWrapper>
        ...
        <FilterWrap>
          <Title className={useType !== '전체' ? 'active' : ''}>용도</Title>
          <Filter>{makeFilterList(useTypeArr, useType, setUseType)}</Filter>
        </FilterWrap>
        <FilterWrap>
...
export default React.memo(SearchOfficetelCp);
