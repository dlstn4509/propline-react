        ...
        <Table>
          <tbody>
            <Tr>
              ...
              <Td>
                <select
                  ...
                  defaultValue={itemList.item_type}
                >
              ...
              <Td>
                <RadioInput
                  ...
                  id="sale"
                  name="trade_type"
                  defaultChecked={itemList.trade_type === '매매'}
                />
                ...
                <RadioInput
                  ...
                  id="charter"
                  name="trade_type"
                  defaultChecked={itemList.trade_type === '전세'}
                />
                ...
                <RadioInput
                  ...
                  id="monthly"
                  name="trade_type"
                  defaultChecked={itemList.trade_type === '월세'}
                />
            ...
            <Tr>
              ...
              <Td>
                <Input type="text" name="company_name" defaultValue={itemList.company_name} />
              </Td>
              <TdTitle>담당자</TdTitle>
              <Td>
                <Input type="text" name="user_name" defaultValue={itemList.user_name} />
              </Td>
            </Tr>
            <Tr>
              <TdTitle>전화번호</TdTitle>
              <Td>
                <Input type="text" name="phone" defaultValue={itemList.phone} />
              </Td>
              <TdTitle>휴대전화</TdTitle>
              <Td>
                <Input type="text" name="mobile" defaultValue={itemList.mobile} />
              </Td>
            </Tr>
            <Tr>
              <TdTitle>제목</TdTitle>
              <Td style={{ display: 'block', paddingTop: '15.5px' }} colSpan="3">
                <Input type="text" name="title" width={'780px'} defaultValue={itemList.title} />
              </Td>
            </Tr>
          </tbody>
        </Table>
        <TextareaWrap>
          <textarea name="contents" cols="30" rows="10" defaultValue={itemList.contents}></textarea>
        </TextareaWrap>
        <BtnWrap>
