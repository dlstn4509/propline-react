...
const UpdateCp = ({ list }) => {
  ...
  const [is_secret, setIs_secret] = useState(`${list.is_secret}`);
  ...
  const removeImgBtn = async (e) => {
    ...
    if (window.confirm('정말 삭제 하시겠습니까? (되돌릴 수 없습니다.)')) {
      ...
      await axios.get(process.env.REACT_APP_URL_API + `freeboard/deleteimg?idx=${list.idx}&col=${col}`);
    }
  };
  ...
  return (
    <FromWrap>
      <form action={process.env.REACT_APP_URL_API + 'freeboard'} method="POST" encType="multipart/form-data">
        ...
        <input type="hidden" name="mod_midx" value={loginUser.midx ? loginUser.midx : 1011} />
        <Table>
          <tbody>
            <Tr>
              <TdTitle>제목</TdTitle>
            ...
            {!list.record_pw && (
              <input
                type="hidden"
                name="loginUser_member_id"
                value={loginUser.midx ? loginUser.member_id : 1011}
              />
            )}
            {list.record_pw && (
              <>
                <Tr>
                  ...
                  <TdFlex>
                    <Input type="text" name="member_id" value={list.member_id} readOnly />
                  </TdFlex>
                </Tr>
                <Tr>
                  <TdTitle>회사명</TdTitle>
                  <TdFlex>
                    <Input type="text" name="company_name" defaultValue={list.company_name} />
                  </TdFlex>
                </Tr>
                <Tr>
                  <TdTitle>이름</TdTitle>
                  <TdFlex>
                    <Input type="text" name="user_name" defaultValue={list.user_name} />
                  </TdFlex>
                </Tr>
                <Tr>
                  <TdTitle>전화번호</TdTitle>
                  <TdFlex>
                    <Input type="text" name="phone" defaultValue={list.phone} />
                  </TdFlex>
                </Tr>
                <Tr>
                  <TdTitle>핸드폰번호</TdTitle>
                  <TdFlex>
                    <Input type="text" name="mobile" defaultValue={list.mobile} />
                  </TdFlex>
                </Tr>
                <Tr>
                  <TdTitle>이메일</TdTitle>
                  <TdFlex>
                    <Input type="text" name="email" defaultValue={list.email} />
                  </TdFlex>
                </Tr>
                <Tr>
                ...
                {list.photo1FilePath && (
                  <ThumbDiv>
                    <div className="img-wrap">
                      <img
                        src={process.env.REACT_APP_URL + `uploads/freeboard/${list.photo1FilePath}`}
                        alt=""
                      />
                    </div>
              ...
              <Td>
                ...
                {list.photo2FilePath && (
                  <ThumbDiv>
                    <div className="img-wrap">
                      <img
                        src={process.env.REACT_APP_URL + `uploads/freeboard/${list.photo2FilePath}`}
                        alt=""
                      />
                    </div>
              ...
              <Td>
                ...
                {list.photo3FilePath && (
                  <ThumbDiv>
                    <div className="img-wrap">
                      <img
                        src={process.env.REACT_APP_URL + `uploads/freeboard/${list.photo3FilePath}`}
                        alt=""
                      />
                    </div>
              ...
              <Td>
                ...
                {list.photo4FilePath && (
                  <ThumbDiv>
                    <div className="img-wrap">
                      <img
                        src={process.env.REACT_APP_URL + `uploads/freeboard/${list.photo4FilePath}`}
                        alt=""
                      />
                    </div>
              ...
              <Td>
                ...
                {list.photo5FilePath && (
                  <ThumbDiv>
                    <div className="img-wrap">
                      <img
                        src={process.env.REACT_APP_URL + `uploads/freeboard/${list.photo5FilePath}`}
                        alt=""
                      />
                    </div>
        ...
        <BtnWrap>
          <Btn bg={'#3168ff'} mr={'10px'} type="button" onClick={btSubmit}>
            수정
          </Btn>
          <Btn
            bg={'#888f91'}
