...
const ShortOtherTextCp = ({ signJumin, signName }) => {
  return (
    <ShortOtherTextCpWrap>
      ...
      <ContractorInfoWrap>
        {'<< 위임자(임차인) 주민등록번호 :'}
        <Input type="text" name="sign_jumin" width={'150px'} defaultValue={signJumin} />
        &nbsp;
        {', 성 명 :'}
        <Input type="text" name="sign_name" width={'150px'} defaultValue={signName} />
        &nbsp;&nbsp;&nbsp;&nbsp;
        {'(인) >>'}
      </ContractorInfoWrap>
    </ShortOtherTextCpWrap>
