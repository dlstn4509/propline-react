...
const SubTitleCp = ({ formType }) => {
  return (
    <SubTitleWrapper>
      ...
      {formType !== 'sale' && (
        <>
          {formType === 'lease' && <SubTitle>부동산 임대차(전세) 계약서</SubTitle>}
          {formType === 'rental' && <SubTitle>부동산 임대차(월세) 계약서</SubTitle>}
          {formType === 'short' && <SubTitle>부동산 단기임대 계약서</SubTitle>}
          <Text>
